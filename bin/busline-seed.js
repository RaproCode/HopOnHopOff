...
Busline.insertMany(blueLine)
  .then(busResult => {
    console.log(`Inserted $(busResult.length} BLUELINE)`);
  })
  .catch(err => {
    console.log("Insert FAILURE!!", err);
  });

module.exports = blueLine;

Busline.insertMany(redLine)
  .then(busResult => {
    console.log(`Inserted $(busResult.length} REDLINE)`);
  })
  .catch(err => {
    console.log("Insert FAILURE!!", err);
  });
