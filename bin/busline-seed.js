...
const blueLine = [
  {
    startingCity: "Paris",
    itinerary: "Paris – Reims – Luxembourg",
  ...
  {
    startingCity: "Luxembourg",
    itinerary: "Luxembourg – Trier – Koblenz – Rudesheim am Rhein – Frankfurt",
    hotel: "Hotel NH Frankfurt airport West",
    image: "/images/koblenz.jpg",
    cost: 99,
    visit:
  ...
  },
  {
    ...
    itinerary: "Frankfurt – Bonn – Cologne – Amsterdam",
    hotel: "Hilton Amsterdam Airport Schiphol",
    image: "/images/ams1.jpg",
    cost: 99,
    visit:
  ...
  },
  {
    ...
    itinerary: "Amsterdam – Zaanse Schans – Amsterdam",
    hotel: "Hilton Amsterdam Airport Schiphol",
    image: "/images/ams2.jpg",
    cost: 99,
    visit:
  ...
  {
    startingCity: "Amsterdam",
    itinerary: "Amsterdam – Brussels – Paris",
...
const redLine = [
  ...
  {
    startingCity: "Budapest",
    itinerary: "Budapest – Vienna",
  ...
  {
    startingCity: "Vienna",
    itinerary: "Vienna – Mondsee – Munich",
  ...
  {
    itinerary: "Munich – Mount Titlis – Lucerne – Zürich",
  ...
  {
    startingCity: "Zurich",
    itinerary: "Zürich – Rhein Falls – Titisee – Frankfurt",
    hotel: "Hotel NH Frankfurt airport West",
...
Busline.create({ name: "Blue Line", cities: blueLine })
  .then(busResult => {
    console.log(`Inserted BLUELINE`);
  })
  .catch(err => {
    console.log("Insert FAILURE!!", err);
  });

Busline.create({ name: "Red Line", cities: redLine })
  .then(busResult => {
    console.log(`Inserted REDLINE`);
  })
  .catch(err => {
    console.log("Insert FAILURE!!", err);
  });
